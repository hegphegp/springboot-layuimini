 ...
 * @date 20-5-20
 */
public interface SqlTemplateService extends JPAService<SqlTemplate, String> {

    /** 组织机构在同级的排序 */
    Long queryMaxOrderNo();
    Long queryNextOrderNo();
    void exchangeOrder(String id1, String id2);
    SqlTemplate queryLessSortOrder(SqlTemplate current);
    SqlTemplate queryGreaterSortOrder(SqlTemplate current);
